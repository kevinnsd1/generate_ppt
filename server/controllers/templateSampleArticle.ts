...
<head>
  <meta charset="UTF-8" />
  <title>widget sample article</title>
  <script
...
<body>
  <div class="post-container">
    ...
    <p class="detail">${sourceName} | <span id="date"></span></p>
    <object data="data:image/jpeg;base64,${imgBase64}" type="image/jpeg" width="100%" class="article-img">
      <img src="data:image/jpeg;base64,${defaultImage}" alt="" class="article-img" />
    </object>
  </div>
  <script>
    document.querySelector("#date").innerHTML = dayjs(
      new Date("${datePublished}")
    ).add(7, 'hour').format("ddd D MMM, YYYY h:mm A");
  </script>
</body>
